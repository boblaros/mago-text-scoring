...
export const ARTIFACT_REQUIREMENTS: Record<FrameworkType, ArtifactRequirement[]> = {
  ...
  pytorch: [
    ...
    },
    {
      ...
      title: "Runtime Config Assets",
      required: true,
      accepts: ".bin,.joblib,.json,.pkl,.txt,.yaml,.yml",
    ...
    },
    {
      ...
      required: false,
      accepts: ".json,.joblib,.pkl",
      hint: "Optional class mapping artifact for runtime decoding.",
    },
    {
      slot: "label_classes_file",
      title: "Label Classes",
  ...
  sklearn: [
    ...
    },
    {
      ...
      required: true,
      accepts: ".joblib,.json,.pkl,.txt,.yaml,.yml",
      ...
      framework === "transformers"
        ...
        : framework === "pytorch"
          ? {
              ...
              config: ["config.json"],
              label_map_file: "class2id.json",
              label_classes_file: "label_classes.json",
